...
6. Troubleshooting
   ...
   6.2 Baud rate mismatch under Linux kernel newer than 4.10

   This is a problem of the build-in kernel module. Please follow below steps
   ...
   6.3 /dev/ppp device always try to reconnect while dail-in/dail-out
   ...
   6.4 MOXA PCIE device can't read/write data in virtual machine.
